  ...
  return (
    <div className="wrapper clear">
      ...
      <div className="d-flex">
        <div className="card">
            <img width={133} height={112} src="/img/image 1.jpg" alt="sneakers 1" />
            <h5>Man's sneakers Nike Air Max 270 </h5>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/image 2.png" alt="sneakers 2" />
          ...
          <div className="card">
            <img width={133} height={112} src="/img/image 3.jpg" alt="sneakers 3" />
          ...
          <div className="card">
            <img width={133} height={112} src="/img/image 4.jpg" alt="sneakers 4" />
            <h5>Man's sneakers Puma X Aka Boku Future Rider </h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Price:</span>
